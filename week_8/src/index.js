...
import homeRouter from "../routes/home"; // routes 폴더의 home.js 파일 사용 /홈화면 기능
import updateRouter from "../routes/update"; // routes 폴더의 update.js 파일 사용 /업데이트 화면 기능
import selectRouter from "../routes/select"; // routes 폴더의 select.js 파일 사용 /선택 화면 기능
...
app.use('/', homeRouter); // home 화면의 router 주소
app.use('/update', updateRouter); // home 화면에서 update 주소로 갔을 때 해당 화면이 나타남
